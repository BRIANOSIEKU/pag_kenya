...
<div class="container mx-auto py-12 px-4">
    ...
    <div class="hero-center text-center px-4">
        ...
        <h1 class="text-4xl md:text-5xl font-bold text-gray-800 relative inline-block mb-4">
            <span class="underline-creative">Support Our Mission</span>
        </h1>

        <!-- ================== Paragraph in White Card ================== -->
        <div class="description-card max-w-3xl mx-auto mb-8">
    ...
    @keyframes drawGlowUnderline {
        0% { transform: translateX(-50%) scaleX(0); box-shadow: 0 0 0 rgba(251,191,36,0); }
        50% { transform: translateX(-50%) scaleX(0.5); box-shadow: 0 0 6px rgba(251,191,36,0.6); }
        100% { transform: translateX(-50%) scaleX(1); box-shadow: 0 0 10px rgba(251,191,36,0.8); }
    }
    ...
    @media (max-width: 768px) {
        .underline-creative::after { width: 50%; height: 3px; bottom: -4px; }
        p { font-size: 1rem; }
        h1 { font-size: 1.8rem; }
        .profile-card img { width: 100px; height: 70px; }
    ...
    <div class="flex justify-center mt-12">
        <a href="{{ route('giving.form') }}" class="give-now-btn">Give Now</a>
    </div>
...
.give-now-btn {
    ...
    padding: 20px 50px;
    border-radius: 12px;
    background: linear-gradient(90deg, #04b12f, #05c70f);
...
.give-now-btn:hover {
    background: linear-gradient(90deg, #09a143, #13f50b);
    transform: scale(1.1);
...
.roman-list li { margin-bottom: 12px; }

@media (max-width: 768px) { .profile-card { padding: 20px; } }
</style>
@endsection