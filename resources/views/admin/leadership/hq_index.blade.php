...
@section('content')
<div class="container">
    <h2 class="mb-4">PAG Kenya HQ Staff</h2>
    ...
    <table style="width:100%; border-collapse:collapse; border:1px solid #ccc;">
        ...
        <tbody>
            @forelse($leaders as $leader)
                <tr>
                    ...
                    <td style="padding:10px; border:1px solid #ccc; display:flex; gap:5px; justify-content:center;">
                        ...
                        <form action="{{ route('admin.leadership.destroy', ['hq', $leader->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this member?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" 
            ...
            @empty
                <tr>
                    <td colspan="6" style="text-align:center; padding:15px;">No HQ Staff found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
